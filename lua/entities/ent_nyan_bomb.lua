...
if ( CLIENT ) then
	killicon.Add( "ent_nyan_bomb", "nyan/killicon_bomb", color_white )
	return
end
...
function ENT:PhysicsCollide( data, physobj )
	...
	-- The damage
	util.BlastDamage( self, self:GetOwner(), self:GetPos(), self.DamageRadius, self.DamageRadius )
